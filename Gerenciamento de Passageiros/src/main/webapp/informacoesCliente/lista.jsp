	...
	<div class="Wrapper">
		...
		<div class="block-inner">
			...
			<div class="Section-header">
				<p class="Section-subTitle">${cliente.nomeCompleto}</p>
			</div>
			<div class="Section-content">
				<div class="col-sm-12">
				 <div class="col-sm-6">
				 <h3>Controle de Presença nos Ultimos 5 dias</h3>
				 <table class="table">
						<thead>
							<tr>
								<th>Nome</th>
						...
						<tbody>
							<c:forEach items="${listaControlePresenca}" var="c">
								<tr>
									...
									<td><fmt:formatDate value="${c.data}" pattern="dd/MM/yyyy HH:mm:ss" />
									</td>
									<td>
										<c:if test="${c.indo_voltando == false}">
											<p style="color:green;">Voltando</p>
										</c:if>
										<c:if test="${c.indo_voltando == true}">
						...
						<a href="relatorioPresenca">Mais Informações</a>
					</div>
					<div class="col-sm-6">
					 <h3>Financeiro do Mês Atual</h3>
						<table class="table">
						<thead>
							<tr>
								<th>Nome</th>
					 ...
					 <a href="relatorioFinanceiro">Mais Informações</a>
